...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("teonatsiramua@gmail.com");
    setCopied(true);
  };
  ...
  return (
    ...
    >
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        {id === 6 && (
          <BackgroundGradientAnimation>
            <div
             ...
             text-white font-bold px-4 pointer-events-none text-3xl text-center 
        ...
        >
          <div
            className="font-sans font-extralight md:max-w-32 md:text-xs 
